...
class MainWindow:
    ...
    def machineCalculateLassoEnsemble(self,val_duration,val_credit,val_dispIncome,val_residence,val_age,val_numOfCredits,val_numOfLiable,valrad_smaller0,valrad_noChecking,valrad_critical,valrad_dullyTill,valrad_carUsed,valrad_radioTv,valrad_smaller100,valrad_noSaving,valrad_emp1to4,valrad_emp4to7,valrad_emp7,valcheck_femaleDivSepMar,valcheck_maleSingle,valcheck_otherDebtors,valrad_carOrOther,valrad_realEstate,valrad_savingLifeIns,valcheck_otherInstallment,valcheck_housingown,valcheck_jobSkilledEmp,valcheck_jobUnsRes,valrad_telNo,valrad_telYes,valcheck_foreignWorker):
        import numpy as np
        import pandas as pd
        ...
        tahmin = np.array([val_duration,val_credit,val_dispIncome,val_residence,val_age,val_numOfCredits,val_numOfLiable,valrad_smaller0,valrad_noChecking,valrad_critical,valrad_dullyTill,valrad_carUsed,valrad_radioTv,valrad_smaller100,valrad_noSaving,valrad_emp1to4,valrad_emp4to7,valrad_emp7,valcheck_femaleDivSepMar,valcheck_maleSingle,valcheck_otherDebtors,valrad_carOrOther,valrad_realEstate,valrad_savingLifeIns,valcheck_otherInstallment,valcheck_housingown,valcheck_jobSkilledEmp,valcheck_jobUnsRes,valrad_telNo,valrad_telYes,valcheck_foreignWorker]).reshape(1,31)
        print(tahmin)
    ...
    def machineCalculateBorutaEnsemble(self,val_duration,val_credit,val_dispIncome,val_residence,val_age,valrad_0to200,valrad_smaller0,valrad_nocheck,valcheck_critical,valcheck_smaller100,valcheck_other,valcheck_housingown):
        import numpy as np
        import pandas as pd
        from sklearn.model_selection import train_test_split
        from sklearn.preprocessing import StandardScaler
    ...
    def machineCalculateChiEnsemble(self,val_duration,val_credit,val_age,valrad_0to200,valrad_smaller0,valrad_nocheck,valrad_paiddully,valrad_critical,valrad_nocredittaken,valcheck_purposeCarUsed,valrad_smaller100,valrad_noSaving,valcheck_empSincesmaller1,valcheck_propertyRealEst,valcheck_propertyNo):
        import numpy as np
        import pandas as pd
        from sklearn.ensemble import RandomForestClassifier
        from sklearn.linear_model import LogisticRegression
        ...
        tahmin = np.array([val_duration,val_credit,val_age,valrad_0to200,valrad_smaller0,valrad_nocheck,valrad_paiddully,valrad_critical,valrad_nocredittaken,valcheck_purposeCarUsed,valrad_smaller100,valrad_noSaving,valcheck_empSincesmaller1,valcheck_propertyRealEst,valcheck_propertyNo]).reshape(1,15)
        print(tahmin)
        tahmin=sc.transform(tahmin)
        print(tahmin)
        model.predict(tahmin)
    ...
    def machineCalculateLassoNeural(self,val_duration,val_credit,val_dispIncome,val_residence,val_age,val_numOfCredits,val_numOfLiable,valrad_smaller0,valrad_noChecking,valrad_critical,valrad_dullyTill,valrad_carUsed,valrad_radioTv,valrad_smaller100,valrad_noSaving,valrad_emp1to4,valrad_emp4to7,valrad_emp7,valcheck_femaleDivSepMar,valcheck_maleSingle,valcheck_otherDebtors,valrad_carOrOther,valrad_realEstate,valrad_savingLifeIns,valcheck_otherInstallment,valcheck_housingown,valcheck_jobSkilledEmp,valcheck_jobUnsRes,valrad_telNo,valrad_telYes,valcheck_foreignWorker):
        import numpy as np
        import pandas as pd
        from sklearn.model_selection import train_test_split
        from sklearn.preprocessing import StandardScaler
    ...
    def machineCalculateChiNeural(self,val_duration,val_credit,val_age,valrad_0to200,valrad_smaller0,valrad_nocheck,valrad_paiddully,valrad_critical,valrad_nocredittaken,valcheck_purposeCarUsed,valrad_smaller100,valrad_noSaving,valcheck_empSincesmaller1,valcheck_propertyRealEst,valcheck_propertyNo):
        import numpy as np
        import pandas as pd
        from sklearn.model_selection import train_test_split
        from sklearn.preprocessing import StandardScaler
    ...
    def machineCalculateBorutaNeural(self,val_duration,val_credit,val_dispIncome,val_residence,val_age,valrad_0to200,valrad_smaller0,valrad_nocheck,valcheck_critical,valcheck_smaller100,valcheck_other,valcheck_housingown):
        import numpy as np
        import pandas as pd
        from sklearn.model_selection import train_test_split
        from sklearn.preprocessing import StandardScaler
    ...
    def getValuesChi(self):
        ...
        if(self.ui.radioButton_5.isChecked()):
            self.machineCalculateChiNeural(val_duration, val_credit, val_age, valrad_0to200, valrad_smaller0, valrad_nocheck, valrad_paiddully, valrad_critical, valrad_nocredittaken, valcheck_purposeCarUsed, valrad_smaller100, valrad_noSaving, valcheck_empSincesmaller1, valcheck_propertyRealEst, valcheck_propertyNo)
        
        if(self.ui.radioButton_6.isChecked()):
            self.machineCalculateChiEnsemble(val_duration, val_credit, val_age, valrad_0to200, valrad_smaller0, valrad_nocheck, valrad_paiddully, valrad_critical, valrad_nocredittaken, valcheck_purposeCarUsed, valrad_smaller100, valrad_noSaving, valcheck_empSincesmaller1, valcheck_propertyRealEst, valcheck_propertyNo)
    ...
    def getValuesLasso(self):
        ...
        if(self.ui.radioButton_5.isChecked()):   
            self.machineCalculateLassoNeural(val_duration,val_credit,val_dispIncome,val_residence,val_age,val_numOfCredits,val_numOfLiable,valrad_smaller0,valrad_noChecking,valrad_critical,valrad_dullyTill,valrad_carUsed,valrad_radioTv,valrad_smaller100,valrad_noSaving,valrad_emp1to4,valrad_emp4to7,valrad_emp7,valcheck_femaleDivSepMar,valcheck_maleSingle,valcheck_otherDebtors,valrad_carOrOther,valrad_realEstate,valrad_savingLifeIns,valcheck_otherInstallment,valcheck_housingown,valcheck_jobSkilledEmp,valcheck_jobUnsRes,valrad_telNo,valrad_telYes,valcheck_foreignWorker)
        if(self.ui.radioButton_6.isChecked()):
           self.machineCalculateLassoEnsemble(val_duration, val_credit, val_dispIncome, val_residence, val_age, val_numOfCredits, val_numOfLiable, valrad_smaller0, valrad_noChecking, valrad_critical, valrad_dullyTill, valrad_carUsed, valrad_radioTv, valrad_smaller100, valrad_noSaving, valrad_emp1to4, valrad_emp4to7, valrad_emp7, valcheck_femaleDivSepMar, valcheck_maleSingle, valcheck_otherDebtors, valrad_carOrOther, valrad_realEstate, valrad_savingLifeIns, valcheck_otherInstallment, valcheck_housingown, valcheck_jobSkilledEmp, valcheck_jobUnsRes, valrad_telNo, valrad_telYes, valcheck_foreignWorker) 
    ...
    def getValuesBoruta(self):
        ...
        if(self.ui.radioButton_6.isChecked()):
            self.machineCalculateBorutaEnsemble(val_duration, val_credit, val_dispIncome, val_residence, val_age, valrad_0to200, valrad_smaller0, valrad_nocheck, valcheck_critical, valcheck_smaller100, valcheck_other, valcheck_housingown)  
        if(self.ui.radioButton_5.isChecked()):    
            self.machineCalculateBorutaNeural(val_duration,val_credit,val_dispIncome,val_residence,val_age,valrad_0to200,valrad_smaller0,valrad_nocheck,valcheck_critical,valcheck_smaller100,valcheck_other,valcheck_housingown)
